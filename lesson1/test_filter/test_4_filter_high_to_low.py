# 2. Проверка работоспособности фильтра (high to low)
...
def test_filter_4():
    ...
    #  Сортируем список цен по убыванию
    sort_values_items_price_before = sorted(values_items_price_before)[::-1]
    time.sleep(3)

    # Находим фильтр, с помощью Keys.PAGE-DOWN выбираем последний пункт списка, клавиша ENTER (Keys.RETURN)
    ...
    # Формируем список цен после использования фильтра HIGH TO LOW
