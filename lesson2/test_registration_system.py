...
def test_registration_without_pre_post_conditions():
    # Шаги тест кейса 001
    system = RegistrationSystem()
    system.register("Nata", "nata@example.com", "+1234567890")
    users = system.view_all_users()
    assert "nata@example.com" in users # Ожидаемый результат

def test_registration_with_pre_post_conditions(init_system):
    # Шаги тест кейса 002
    init_system.register("Nata", "nata@example.com", "+1234567890")
